    ...
    <form>
      ...
      >
        <div class="flex items-center">
          ...
          <label class="text-white text-[15px] leading-none pl-[15px]" htmlFor="r1">
            Default
          </label>
        </div>
        <div class="flex items-center">
          ...
          <label class="text-white text-[15px] leading-none pl-[15px]" htmlFor="r2">
            Comfortable
          </label>
        </div>
        <div class="flex items-center">
          ...
          <label class="text-white text-[15px] leading-none pl-[15px]" htmlFor="r3">
            Compact
          </label>
        </div>
      </OkuRadioGroup>
