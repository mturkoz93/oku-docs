    ...
    >
      <OkuTabsList class="shrink-0 flex border-b border-mauve6" aria-label="Manage your account">
        <OkuTabsTrigger
          ...
          :key="tab.name"
          class="bg-gray-100 dark:bg-grayA-900 px-5 h-[45px] flex-1 flex items-center justify-center text-[15px] leading-none text-mauve11 select-none first:rounded-tl-md last:rounded-tr-md hover:text-oku-500 data-[state=active]:text-oku-500 data-[state=active]:shadow-[inset_0_-1px_0_0,0_1px_0_0] data-[state=active]:shadow-current data-[state=active]:focus:relative data-[state=active]:focus:shadow-[0_0_0_2px] data-[state=active]:focus:shadow-black outline-none cursor-default"
          :value="tab.name"
        >
          {{ tab.title }}
        </OkuTabsTrigger>
